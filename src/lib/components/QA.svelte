	...
	let questions = [
		{
			...
			isOpen: false,
			answer:
				"A Memory Lock is a unique padlock featuring a laser-engraved QR code. When scanned, it opens a public digital album containing both images and videos, where the owner's most cherished memories are stored for the world to discover.",
			type: 'text'
		},
		{
			id: 2,
